...
(function () {
    ...
    define_variable("password_manage_generate_password_shortcut", "C-w x", "Press to generate password for current site");
    define_variable("password_manage_password_paste_key", "C-t", "Key to use to paste passwords and usernames into focused text boxes");
    define_variable("password_manage_lastpass_username", "", "Default username to login to LastPass");
    define_variable("password_manage_setup_keybindings_p", true, "NOT WORKING? - Whether to setup the default keybindings");
    define_variable("password_manage_debug_p", false, "Enable debug mode. " + "WARNING - this will print confidential material, like your passwords, to the console, and possible other logs!");
    define_variable("password_manage_settings", [], "Register and enable different password managers");
    ...
    interactive("passwd-generate-and-save", "generates and saves a password for the provided username and domain", generate_and_save);
    interactive("passwd-get-username-and-password", "retrieves the username and password for given domain, " + "sets 'password_manage_password_paste_key' to paste username and then password into focused fields", get_username_and_password);
    ...
    function setup_value_paster(I, value, type) {
        var onSuccess = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
        ...
        if (!onSuccess) {
            ...
            onSuccess = function () {
                ...
                interactive("passwd-set-value", "does nothing - no password set", function () {});
            };
        }
        interactive("passwd-set-value", "sets the current " + type + " into the current field", function (I) {
